...
def load_legal_chunks(base_dir="legal_knowledge_new"):
    docs = []
...
def build_legal_vectorstore():
    ...
    vs.save_local("legal_vectorstore_new")
...
def load_legal_vectorstore():
    ...
    return FAISS.load_local("legal_vectorstore_new", embeddings, allow_dangerous_deserialization=True)
